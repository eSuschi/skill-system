...
5. Remaining local skill bodies that lived only in the sandbox are persisted locally and in the zip/backup; newly missing bodies were pushed under `Grok/skills/`.
...
**Status:** accepted + fully executed. Re-enforced 2026-08-25 after residual local reappearance. Re-enforced 2026-08-26 after another local reappearance.
